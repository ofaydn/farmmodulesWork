...
#define rx 10            // RX pin for pH sensor (Atlas sensor)
#define tx 9             // TX pin for pH sensor (Atlas sensor)
#define rxdo 12          // RX pin for DO sensor (Atlas sensor)
#define txdo 11          // TX pin for DO sensor (Atlas sensor)

SoftwareSerial atlasph(tx, rx);    // SoftwareSerial object for pH sensor
SoftwareSerial atlasdo(txdo, rxdo); // SoftwareSerial object for DO sensor
